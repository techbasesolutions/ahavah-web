...
// `className` narrowed to `string | undefined` (Base UI's RadioGroup.Root
// supports a callback form for className that we pass through to Field, which
// only accepts string — this discards that callback form here).
