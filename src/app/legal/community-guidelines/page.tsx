  ...
  return (
    <PageShell bottomPad="default">
      ...
      <article className="flex flex-col gap-4 px-5 pt-4 text-body leading-relaxed text-(--ink-2)">
        ...
        <h2 className="mt-2 text-h3 text-(--ink)">Be kind</h2>
        <p>
        ...
        <h2 className="mt-2 text-h3 text-(--ink)">Be real</h2>
        <p>
        ...
        <h2 className="mt-2 text-h3 text-(--ink)">Be safe</h2>
        <p>
        ...
        <h2 className="mt-2 text-h3 text-(--ink)">If you see something</h2>
        <p>
